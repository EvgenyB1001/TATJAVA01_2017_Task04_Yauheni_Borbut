package com.epam.task03.lib.dao.utils.db;

import com.epam.task03.lib.dao.utils.db.exception.ConnectionPoolException;
import com.epam.task03.lib.dao.utils.db.properties.DBResourceManager;
...
public final class ConnectionPool {
    ...
    /**
     * Constructor gets parameters from .properties file by object of special class
     */
    ...
    public void initConnectionPool() throws ConnectionPoolException {
        ...
        try {
            ...
            throw new ConnectionPoolException("SQL exception during executing", e);
        } catch (ClassNotFoundException e2) {
            throw new ConnectionPoolException("DB driver class is not found", e2);
        }
    }
    ...
    public void closeConnections(BlockingQueue<Connection> queue) throws SQLException, InitializationException {
        if (queue == null) {
            throw new InitializationException("Queue to close isn't initialized");
        }
    ...
    private class PoolConnection implements Connection {
        ...
        public void close() throws SQLException {
            if (connection.isClosed()) {
                throw new SQLException("Can't close already closed connection");
            }
            ...
            if (!connectionsQueue.offer(this)) {
                throw new SQLException("Exception while executing returning connection to pool");
            }

            if (!givenAwayConnectionsQueue.remove(this)) {
                throw new SQLException("Exception while executing removing from pool of given connections");
            }
        }
